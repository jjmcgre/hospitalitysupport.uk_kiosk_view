          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 22 }}>
              <div style={{ flex: 1 }}>
                ...
                <h1 style={{
                  color: W, fontSize: 26, fontWeight: 900, margin: '0 0 9px',
                  lineHeight: 1.05, letterSpacing: '-0.03em',
                }}>
                  Every area of your operation.<br />
                  <span style={{ color: TL }}>All connected. Always live.</span>
                </h1>
                <p style={{ color: S4, fontSize: 11, margin: 0, lineHeight: 1.55, maxWidth: 430 }}>
          ...
          <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: 0, position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 5 }}>
                  {caps.map((c, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{ color: S5, fontSize: 9, lineHeight: 1.35 }}>{c.note}</div>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  {scenarios.map((s, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        <div style={{ color: '#fca5a5', fontSize: 11, fontWeight: 700, marginBottom: 3 }}>{s.trigger}</div>
                        <div style={{ color: S4, fontSize: 10, lineHeight: 1.4 }}>{s.outcome}</div>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: 8, fontWeight: 800, color: TL, textTransform: 'uppercase', letterSpacing: '0.14em', marginBottom: 10 }}>
                  Pricing
                </div>
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{ textAlign: 'right', lineHeight: 1 }}>
                      <span style={{ color: TL, fontSize: 18, fontWeight: 900 }}>{p.price}</span>
                      <span style={{ color: S5, fontSize: 9, marginLeft: 2 }}>{p.period}</span>
                    </div>
                  </div>
                ))}
                <div style={{ marginTop: 9, paddingTop: 9, borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', gap: 5, flexWrap: 'wrap' }}>
