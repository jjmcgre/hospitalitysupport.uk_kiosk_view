...
export const tiktokVideos: TikTokVideo[] = [
  {
    ...
    captionLines: [
      "Someone asked me what HospitalitySupport.uk actually does.",
      "",
      "Honest answer:",
  ...
  },
  {
    ...
    captionLines: [
      ...
      "",
      "£3.30 a day. HospitalitySupport.uk",
      "Link in bio.",
    ],
  ...
  },
  {
    ...
    beats: [
      ...
      { tag: 'The fix', headline: "HospitalitySupport.uk", sub: "Catches all of it. Every day.", enter: 'scale-in', durationMs: 2400 },
    ...
    captionLines: [
      ...
      "",
      "HospitalitySupport.uk catches all of it.",
      "Every day.",
      "",
