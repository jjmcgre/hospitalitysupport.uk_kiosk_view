...
const adHeadlines = [
  ...
  "ServiceSupport.UK — expertise without the payroll.",
];

const adBodies = [
  "ServiceSupport.UK gives hospitality operators a full operations team — menu development, GP control, compliance, training, and allergen management — for £3.30 a day. Priced per kitchen, not per user.",
  "Supplier prices change. Margins drift. Staff turn over. ServiceSupport.UK monitors all of it, continuously — so you don't have to.",
  "Most hospitality software assumes trained users, time, and discipline. ServiceSupport.UK is built for the reality: high turnover, low margins, constant pressure. It builds itself around how you work.",
  ...
  "From £100/month per kitchen, ServiceSupport.UK is the operations team you never had to hire. No payroll. No sick days. No politics.",
  "Multi-site operators: one price per kitchen, central visibility across all sites, consistent standards without micromanagement. ServiceSupport.UK scales with you.",
  "Dark kitchens and production kitchens have unique operational demands. ServiceSupport.UK High-Intensity Kitchen tier is built for high-churn, multi-brand environments.",
  "If you can send a message, you can use ServiceSupport.UK. No training required. No onboarding. Just ask what you need.",
  "The hospitality industry is losing experienced people. ServiceSupport.UK maintains standards that don't depend on who's in this week.",
