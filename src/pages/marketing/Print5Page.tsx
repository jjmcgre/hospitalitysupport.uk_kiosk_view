      ...
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-6 no-print">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => {
                const url = `${window.location.origin}/sales-pack`;
                window.open(`https://wa.me/?text=${encodeURIComponent(url)}`, '_blank', 'noopener,noreferrer');
              }}
              className="flex items-center gap-1.5 bg-slate-700 hover:bg-green-600/20 hover:text-green-400 hover:border-green-500/40 text-slate-400 border border-slate-600 font-semibold px-4 py-2.5 rounded-xl text-sm transition-colors"
            >
