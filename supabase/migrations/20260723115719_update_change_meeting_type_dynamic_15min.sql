-- change_meeting_type: works with 15-min grid, dynamically blocks/unblocks buffer
...
BEGIN
  ...
  -- Free all buffer slots for this booking first
  ...
  ELSE
    -- Switching to virtual: re-apply 15-min buffer
