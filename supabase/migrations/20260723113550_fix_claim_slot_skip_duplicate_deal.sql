-- Update claim_slot to accept an optional p_deal_id parameter.
-- When provided (internal team booking against an existing deal),
-- the function links the booking to that deal and skips auto-creating
-- a new deal — preventing duplicate pipeline entries.
...
-- Grant anon access (same as previous migrations)
